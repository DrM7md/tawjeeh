...
export default function DeleteUser() {
    ...
    return (
        <div className="space-y-6">
            <HeadingSmall title="حذف الحساب" description="حذف حسابك وكل بياناته نهائيًا" />
            <div className="space-y-4 rounded-lg border border-red-100 bg-red-50 p-4 dark:border-red-200/10 dark:bg-red-700/10">
                ...
                <Dialog>
                    ...
                    <DialogContent>
                        ...
                        <DialogDescription>
                            بمجرد حذف الحساب، ستُحذف كل بياناته ومصادره نهائيًا. أدخل كلمة المرور لتأكيد رغبتك في الحذف الدائم.
                        </DialogDescription>
